...
export function SocialClient({
  ...
  return (
    <div className="p-4 max-w-lg mx-auto">
      <h1 className="text-lg font-bold text-text-primary mb-6">Social</h1>
        ...
        {followedProfiles.length === 0 ? (
          <div className="card p-6 text-center">
            ...
            <p className="text-xs text-text-muted mt-1">
              Search by email to find people
            </p>
          </div>
        ) : (
          <div className="flex flex-col gap-2">
                ...
                <div className="min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-0.5">
                    ...
                    <span className="text-xs text-text-muted">
                      {Number(profile.total_volume_kg).toLocaleString()} kg
                    </span>
                    {profile.current_week_streak > 0 && (
                      <span className="text-xs text-text-muted">
                        {profile.current_week_streak}w streak
                      </span>
                    )}
